import {t as n} from "./lph.CllSU6W7.js";
(function() {
    try {
        var a = typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}
          , e = new a.Error().stack;
        e && (a._sentryDebugIds = a._sentryDebugIds || {},
        a._sentryDebugIds[e] = "309c6776-ff2b-4441-ad60-dfe24139e7b7",
        a._sentryDebugIdIdentifier = "sentry-dbid-309c6776-ff2b-4441-ad60-dfe24139e7b7")
    } catch {}
}
)();
const r = {
    render: () => n("div", {
        class: "svg-icon",
        innerHTML: `<svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="sad-cry" role="img"
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="svg-inline--fa fa-sad-cry fa-w-16 fa-7x">
    <g class="fa-group">
...
export {r as S};
//# sourceMappingURL=lph.BPsx4-om.js.map
